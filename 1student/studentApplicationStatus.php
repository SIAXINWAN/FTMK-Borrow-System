...
$stmt = $conn->prepare("SELECT ba.ApplicationID, ba.ApplyDate, ba.Purpose, ba.Quantity, ba.ActivityDateTime,
  ...
  <div class="container">
    ...
    <div class="status">
      ...
      <div class="status-item">
        <div class="status-label">Lecturer approval</div>
        <div class="status-box <?php echo getStatusClass($statuses['Lecturer']); ?>">
          <?php echo htmlspecialchars($statuses['Lecturer']); ?>
        </div>
      </div>
      <div class="status-item">
    ...
    <div class="pickup-box">
      <?php
      if (
        $statuses['Lecturer'] === 'Approved' &&
        $statuses['Admin'] === 'Approved' &&
        $statuses['Security Office'] === 'Approved'
      ) {
        echo "The device is approved to be picked up at the lab counter.";
      } else if (
        $statuses['Lecturer'] === 'Rejected' ||
        $statuses['Admin'] === 'Rejected' ||
        $statuses['Security Office'] === 'Rejected'
      ) {
        echo "Your application has been rejected.<br>";

        if ($statuses['Lecturer'] === 'Rejected') {
          echo "<strong>Lecturer's reason:</strong> " . htmlspecialchars($remarks['Lecturer']) . "<br>";
        }
        ...
        if ($statuses['Security Office'] === 'Rejected') {
          echo "<strong>Security Office's reason:</strong> " . htmlspecialchars($remarks['Security Office']) . "<br>";
        }
      } else {
